...
import mnist_service_pb2 as mnist__service__pb2
...
class MnistServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTrainingSamples = channel.unary_stream(
                ...
                request_serializer=mnist__service__pb2.DataRequest.SerializeToString,
                response_deserializer=mnist__service__pb2.Sample.FromString,
                )
...
def add_MnistServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetTrainingSamples': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=mnist__service__pb2.DataRequest.FromString,
                    response_serializer=mnist__service__pb2.Sample.SerializeToString,
            ),
    }
...
class MnistService(object):
    ...
    def GetTrainingSamples(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/MnistService/GetTrainingSamples',
            mnist__service__pb2.DataRequest.SerializeToString,
            mnist__service__pb2.Sample.FromString,
